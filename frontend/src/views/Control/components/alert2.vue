...
<template>
  <div class="storage-container">
    ...
    <!--&lt;!&ndash;        &lt;!&ndash; <svg class="icon" aria-hidden="true" @click="editGroup()">&ndash;&gt;-->
    <!--&lt;!&ndash;          <use xlink:href="#icon-se-icon-f-edit"></use>&ndash;&gt;-->
    <!--&lt;!&ndash;        </svg> &ndash;&gt;&ndash;&gt;-->
    <!--&lt;!&ndash;        <el-button @click="editGroup()"&ndash;&gt;-->
    <!--&lt;!&ndash;        ><svg class="icon" aria-hidden="true">&ndash;&gt;-->
    <!--&lt;!&ndash;          <use xlink:href="#icon-se-icon-f-edit"></use></svg&ndash;&gt;-->
    <!--&lt;!&ndash;        >{{ $t('common.edit') }}</el-button&ndash;&gt;-->
    <!--&lt;!&ndash;        >&ndash;&gt;-->
    <!--&lt;!&ndash;        <el-popconfirm placement="top" :confirmButtonText="$t('common.submit')" :cancelButtonText="$t('common.cancel')" :title="$t('storagePage.deleteGroupConfirm')" @confirm="deleteGroup()">&ndash;&gt;-->
    <!--&lt;!&ndash;          <template #reference>&ndash;&gt;-->
    <!--&lt;!&ndash;            <span class="icon-del">&ndash;&gt;-->
    <!--&lt;!&ndash;              <el-button&ndash;&gt;-->
    <!--&lt;!&ndash;              ><svg class="icon del-icon" aria-hidden="true">&ndash;&gt;-->
    <!--&lt;!&ndash;                  <use xlink:href="#icon-se-icon-delete"></use></svg&ndash;&gt;-->
    <!--&lt;!&ndash;              >{{ $t('common.delete') }}</el-button&ndash;&gt;-->
    <!--&lt;!&ndash;              >&ndash;&gt;-->
    <!--&lt;!&ndash;            </span>&ndash;&gt;-->
